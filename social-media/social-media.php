...
<div class="content-wrapper">
  ...
  <section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>Social Media Table</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">Home</a></li>
            <li class="breadcrumb-item active">Social Media Table</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
        ...
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-header">
                  ...
                  <div class="modal-dialog">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        ...
                        <!-- <div id="social-media-table-data"></div> -->
                      </div>
                    </div>
                  </div>
                </div>
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-body view_employee">
                        <form id="mymodelform">
                          ...
                          <div class="form-group">
                            <label for="image">Icon</label>
                            <!-- Display the image name using PHP -->
              ...
              <div class="card-body">
                <table id="social-setting" class="table table-bordered table-hover">
                  <thead>
                    <tr>
                      <th>ID</th>
                      <th>Name</th>
                  ...
                  <tbody>
                    ...
                    $sql = mysqli_query($conn, "SELECT id, name, icon, description, status FROM social_media_settings order by id desc");
                    $i = 0;
                    ...
                    ?>
                      <tr>
                        ...
                        <td class="align-middle"><img src="images/social/<?php echo $result['icon']; ?>" class="img" width="60" height="60"></td>
...
<script>
    $(document).ready(function() {
      let table = new DataTable('#social-setting');
    });
</script>